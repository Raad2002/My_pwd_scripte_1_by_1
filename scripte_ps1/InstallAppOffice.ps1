...
<Window         
        ...
        Title="Install Office Window" Height="650" Width="560" WindowStartupLocation="CenterScreen" ResizeMode="NoResize">
  ...
  VerticalAlignment="Top" FontSize="16" FontFamily="Segoe Print" Background="Transparent" Foreground="#FFE8D977" Height="38" Width="298"/>
     ...
     <Canvas Margin="121,366,121,83">
         <Button x:Name="InstallOfficeButton" Content="Install Office" 
             ...
             BorderThickness="4" 
             Foreground="White" 
             Height="51" Canvas.Left="53" Width="230" Canvas.Top="10" HorizontalAlignment="Center" VerticalAlignment="Top"/>
         ...
         <Label Content="Chose app when you need to Unistall" 
             ...
             Padding="30,0,5,12" Height="40" Canvas.Top="67" Width="335" RenderTransformOrigin="0.512,0.943" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="10"/>
         ...
         <Button x:Name="UninstallOfficeButton" Content="Unistall Office" 
             ...
             BorderThickness="4" 
             Foreground="White" 
             Height="50" Canvas.Left="53" Canvas.Top="107" Width="230" HorizontalAlignment="Left" VerticalAlignment="Top"/>
